...
{
    public class QuantumEndpointFilterStrategy :INetConnectFilterStrategy, IEndpointSettingStrategy
{
    ...
    public QuantumEndpointFilterStrategy(int n, int counter = 0, int offset = 0)
    {
        if (n==0) n=1;
        _counter = counter;
        _n = n;
    ...
    private List<string> _matchingConnectNames=new List<string>(){"quantum"};
